...
#/////////////////////////////////////////////
#Неудачная попытка решения задачи из-за недопониманности самой задачи, так как я думал что кол-во камней меняется тоже, из-за чего кол-во элементов изменяется при запуске программы, а также я думал что нужно не число, а пара числел из списка кратной сумме элементов из этого списка.
# def old_solver():
#   list_1 = []
#   result = 0
